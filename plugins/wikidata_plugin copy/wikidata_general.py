...
from src.core.services.prov_generator import generate_prov_for_asset, generate_asset_descriptor_jsonld
...
class WikidataQueryExecutor:
    ...
    def execute_sparql_query(self, 
                           ...
                           limit: int = 500,
                           timeout: int = 30,
                           output_format: str = "geojson") -> Dict[str, Any]:
        """
    ...
    def _process_sparql_results(self, raw_data: Dict[str, Any], output_format: str) -> Any:
    ...
    def _convert_to_geojson(self, bindings: List[Dict]) -> Dict[str, Any]:
        ...
        for row in bindings:
            ...
            for var, value_info in row.items():
                ...
                if var == "item" and value.startswith("http://www.wikidata.org/entity/"):
    ...
    def _generate_data_dictionary(self, raw_data: Dict[str, Any], query: str) -> Dict[str, Any]:
    ...
    def _create_asset(self, 
                     ...
                     description: str,
                     query: str,
                     raw_results_count: int) -> Dict[str, Any]:
...
def fetch_wikidata_query(query: str, 
                        title: str,
                        description: str = "",
...
def fetch_museums_bolivia_generalized(output_geojson: str = None, limit: int = 500) -> str:
    """
...
COMMON_QUERIES = {
    "museums_bolivia": {
        ...
        """,
        "title": "Museos de Bolivia",
        "description": "Listado completo de museos en Bolivia con coordenadas y tipos"
    },
...
def fetch_common_query(query_name: str, limit: int = 500) -> Dict[str, Any]:
    ...
    if query_name not in COMMON_QUERIES:
        ...
        raise ValueError(f"Query '{query_name}' no encontrada. Disponibles: {available}")
