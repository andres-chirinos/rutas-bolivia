...
Un aplicación algo **CANCERIGENA** de google maps

```{ojs}
(async () => {
    // Renderiza el contenedor optimizado para pantalla completa con barra lateral
    const container = html`<div id='dashboard' style='position:fixed; top:0; left:0; width:100vw; height:100vh; margin:0; padding:0; background:#fff; z-index:1000; overflow:hidden;'>
        ...
        <div id='sidebar' style='position:absolute; top:0; left:-350px; width:350px; height:100vh; background:#fff; border-right:2px solid #ddd; box-shadow:2px 0 10px rgba(0,0,0,0.1); transition:left 0.3s ease; z-index:1001; overflow-y:auto;'>
            ...
            <div style='padding:15px;'>
                ...
                <div id='tourInfo' style='padding:10px; background:#e3f2fd; border:1px solid #2196f3; border-radius:6px; margin-bottom:15px;'>
                    <strong style='font-size:13px;'>�️ Tour:</strong> <span id='tourList' style='font-size:12px;'>Ningún lugar seleccionado</span>
        ...
        <!-- Botón flotante para abrir sidebar - reposicionado para no tapar zoom -->
